...
function up_cuisine_add_form_fields() {
	?>
		...
		<div class="form-field">
			...
			<p> <?php _e('A URL the user can click on to learn more about this cuisine', 'udemy-plus'); ?>p </p>
		</div>
...
function up_cuisine_edit_form_fields($term) {
	...
	?>
		...
		<tr class="form-field">
			<th><label> <?php _e('More Info URL', 'udemy-plus');  ?> </label> </th>
			<td>
				<input type="text" name="up_more_info_url" value="<?php echo $url; ?>">
				<p class="description"> 
					<?php _e('A URL the user can click on to learn more about this cuisine', 'udemy-plus'); ?>p 
				</p>
			</td>
		</tr>
