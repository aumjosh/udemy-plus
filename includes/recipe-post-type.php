...
function up_recipe_post_type ( ) {
	...
	$args = array(
		...
		'show_ui'            => true,
		'show_in_menu'       => true,
		'query_var'          => true, // ?posttypename=value if true, or you can pass a string to customze the key
		'rewrite'            => array( 'slug' => 'recipe' ),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false, // for most use-cases should be false... this is for if there should be parent recipes that containt child recipes
		'menu_position'      => 20, // default was null... we changed it to place it below the pages menu option
        // leaving the full 'support' option in here to show tht we removed the 'comments' capability for recipes
		// 'supports'           => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'comments' ),
		'supports'           => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt' ),
        // add custom endpoint for using rest api
        'show_in_rest'       => true,
    ...
    register_term_meta('cuisine', 'more_info_url', [
        ...
        'single' => true, // if storing an array, set to false
        'show_in_rest' => true,
        'default' => '#'
    ]);
}